<?php include 'inc/toptitle.php'; require 'function/connectDB.php'; include 'function/date.php'; $sw_f=1;
...
<div class="container box" style="margin-top: 10px;height:auto;">
    <div class="border-box">
        ...
        <label style="color: #3f99e6;font-weight: 600;">การจัดการคำร้องขอสลับห้อง</label>
    </div>
    <h3>การจัดการคำร้องขอสลับห้อง</h3>
    <div class="box-menu row">
        <div class="col-4">
            <div class="mr-ml">
                <label id="label-title">อาคาร</label><br>
                <lable id="lablebuilding">
                <select name="BuildingID" id="BuildingID" onchange="Orderbyswaproom()">
    ...
    <div style="min-height: 350px;"><lable id="listswaproom"></lable></div>
</div>
