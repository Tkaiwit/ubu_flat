...
<div class="container box" style="margin-top: 10px;height:auto;">
    <div class="border-box">
        <i class="icon homes"></i> หน้าหลัก / <label
            style="color: #3f99e6;font-weight: 600;">การจัดการข้อมูลไฟฟ้า</label>
    </div>
    <h3>การจัดการข้อมูลไฟฟ้า</h3>
    <div class="row mb10">
        <div class="col-2">
            <div class="mr-ml">
                <label id="label-title">ประจำเดือน</label>
